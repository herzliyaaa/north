        ...
        <section>
            ...
            <div class="content">
                ...
                <div class="resident-profile">
                    ...
                    <div class="drag-area" id="showFile(this)" name="wew">

                        <img class="upload-icon" src="../img/icons/upload-50 (1).png" id="previewImg" alt="">
                ...
                <div class="infos-container">
                    ...
                    <div class="infos">
                        ...
                        <div class="add-info">
                            <h5>Email Address:</h5>
                            <input type="text" name="email" style="text-transform: lowercase;" onkeyup="this.value = this.value.toLowerCase();">
                        </div>
